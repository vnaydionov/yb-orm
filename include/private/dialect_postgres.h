...
#ifndef YB__ORM__DIALECT_POSTGRES__INCLUDED
#define YB__ORM__DIALECT_POSTGRES__INCLUDED

#include "orm/sql_driver.h"

namespace Yb {

class YBORM_DECL PostgresDialect: public SqlDialect
{
public:
    PostgresDialect();
...
#endif // YB__ORM__DIALECT_POSTGRES__INCLUDED
